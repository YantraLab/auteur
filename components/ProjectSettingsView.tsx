...
export const ProjectSettingsView = ({ settings, handleSettingsChange, setStyleModalOpen, isCollapsed, onToggleCollapse }: ProjectSettingsViewProps) => {
    return (
        <div className="bg-brand-surface rounded-lg border border-brand-muted shadow-card transition-all duration-300">
            <div className="flex justify-between items-center p-3 bg-brand-bg/50 rounded-t-lg">
                ...
                <button 
                    ...
                    className="p-1 rounded-full text-brand-text-dim hover:bg-brand-muted transition-colors" 
            ...
            {!isCollapsed && (
                <div className="p-4 space-y-4 border-t border-brand-muted">
                    <div>
